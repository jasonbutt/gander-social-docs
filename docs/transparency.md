...
![Web Preview with Fact Check](images/web-posting.png)
...
1.  **Paste the URL:** Enter the web address directly into the post composer.
2.  **Activate the Preview:** Tap the **(+)** icon next to the URL input field to generate the verification card.
3.  **Review the Intel:** Before hitting **Post**, check the bias and factuality markers to ensure you are sharing a high-quality signal.
4.  **Add Context:** You can still add your own text and hashtags (like #News) above the link to provide your tactical perspective.
